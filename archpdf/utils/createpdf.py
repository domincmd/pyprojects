...
def load_html(): # this function loads the html file
    html_path = BASE_DIR / "pdfpage.html"
...
def createpdf(url, output): # this needs to be an archlinux wiki page for the script to work, output is the name of the output file
    ...
    HTML(string=soup.prettify()).write_pdf(f"{output}")

    return f"Successfully created pdf {output}.pdf"



createpdf("https://wiki.archlinux.org/title/Installation_guide", "output.pdf")